      ...
      <div className="tvp-card">
        ...
        {!hasTrend ? (
          ...
          <div style={{ width: "100%", height: 260 }}>
            <ResponsiveContainer>
              <BarChart data={report.trend} margin={{ top: 4, right: 8, bottom: 0, left: 8 }}>
                ...
                <YAxis
                  ...
                  axisLine={false}
                  width={70}
                  tickFormatter={(v: number) => fmtMoney(v, report.currency).replace(/,00$/, "")}
                />
                <Tooltip
                  formatter={(v: number, n: string) => [fmtMoney(v, report.currency), n]}
                  contentStyle={{
                    background: "var(--surface)", border: "1px solid var(--tvp-line)",
