...
export function FolderTemplatesPanel() {
  ...
  const { data } = useSuspenseQuery(folderTemplatesListQO);
  const { data: me } = useSuspenseQuery(folderTemplatesMeQO);
