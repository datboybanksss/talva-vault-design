      ...
      <div className="tvp-two-col">
        <div className="tvp-card">
          ...
          <table className="tvp-table">
            <thead>
              <tr><th>Document</th><th>Talent</th><th>Folder</th><th>Status</th><th>Validity</th><th style={{ width: 200 }}></th></tr>
            </thead>
            <tbody>
              <tr>
                <td>
                  ...
                  <span style={{ marginLeft: 6, display: "inline-flex", alignItems: "center", gap: 4, color: "var(--tvp-amber, #b45309)", fontSize: 12 }}>
