    ...
    <>
      ...
      <div className="tvp-card">
        <div className="tvp-toolbar">
          <input className="tvp-search" placeholder="Search roster..." />
          <div className="flex gap-2">
            ...
            <select className="tvp-select"><option>Lead: All</option><option>Thandi Ndlovu</option><option>Sipho Dlamini</option></select>
        ...
        <table className="tvp-table">
          <thead><tr><th>Talent</th><th>Status</th><th>Lead</th><th>Roster Shared Folder</th><th>Documents</th><th>Next Action</th><th></th></tr></thead>
          <tbody>
            {rows.map((r) => (
              <tr key={r.name}>
